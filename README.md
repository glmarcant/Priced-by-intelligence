...
| `robustness_nn_aapl.ipynb`, `robustness_nn_spx.ipynb` | Same robustness check for the neural network | `cv_results_v4_spx.csv` | Cross-validation results for the main SPX XGBoost specification |
